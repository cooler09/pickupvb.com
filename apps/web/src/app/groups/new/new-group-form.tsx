...
export default function NewGroupForm() {
    ...
    return (
        <form action={formAction} className="space-y-4">
            ...
            <div>
                <label htmlFor="slug" className={labelClass}>Slug (URL handle)</label>
                <input
                    id="slug"
                    name="slug"
                    required
                ...
                />
                <p className="mt-1 text-xs text-muted">3–40 chars, lowercase letters, numbers, dashes.</p>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows={3} maxLength={2000} className={inputClass} />
            </div>
