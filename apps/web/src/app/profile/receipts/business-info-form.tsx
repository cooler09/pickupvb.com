        ...
        <form action={formAction} className="space-y-3">
            ...
            <label className="block text-sm">
                ...
                <input
                    ...
                    className="mt-1 w-full rounded-md border border-border-base bg-surface px-3 py-2"
                />
            </label>
            ...
            <label className="block text-sm">
                ...
                <input
                    ...
                    className="mt-1 w-full rounded-md border border-border-base bg-surface px-3 py-2 font-mono"
                />
                <span className="mt-1 block text-xs text-muted">
                    Use an EIN if you have one. Do not enter a Social Security
                    Number — this field is not encrypted beyond the database
                    default.
                </span>
            </label>
