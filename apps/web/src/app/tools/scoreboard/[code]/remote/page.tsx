...
import { RemoteControl } from './_components/remote-control.js';
...
export default async function ScoreboardRemotePage({
  params,
  searchParams,
}: {
  ...
  return <RemoteControl code={code} initialConfig={config} />;
}
