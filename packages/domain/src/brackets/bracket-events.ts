...
export class BracketGenerated extends BaseEvent {
    ...
    constructor(aggregateId: string, public readonly matchCount: number) {
        super(aggregateId);
    }
}
...
export class MatchResultRecorded extends BaseEvent {
    ...
    constructor(
        ...
        public readonly winnerTeamId: string,
    ) {
        super(aggregateId);
    }
}
...
export class MatchReset extends BaseEvent {
    ...
    constructor(aggregateId: string, public readonly matchId: string) {
        super(aggregateId);
    }
}
