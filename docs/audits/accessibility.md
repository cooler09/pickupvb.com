...
- **P2:** `FieldError` → `aria-describedby` + `aria-invalid` wiring across all forms. **Partial** 2026-05-22 (Bundle 2): shared primitive extracted; migrated 2/6 forms. Remaining: `new-event-form`, `edit-event-form`, `community-listing-form`, `community-listing-edit-form`.
