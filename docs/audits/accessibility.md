...
build` green** (356 web tests). **No P1/P2 this pass.** The two carried-over
> backlog refactors (**C7** Radix-dialog migration, **C8** shared Combobox +
> end-to-end AT testing) stay open. Full write-up in
