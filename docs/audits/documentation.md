...
- **P2: API / route-handler reference, JSDoc coverage on domain exports, monitoring doc, database operations guide.** (Server-action pattern doc and audits-index row ✅ closed in Bundle 32; testing strategy doc ✅ closed in Bundle 34.)
