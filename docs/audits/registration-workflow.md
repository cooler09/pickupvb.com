...
_Last updated: 2026-05-27 (Bundle 117 re-audit)_
...
#### R4 (P2) — Walk-ins are not a first-class registration type
...
- **Model R3 (P2, new 2026-05-27)** — `team_registration_mode` is
  event-level; user asked for per-division. See **R3**. Requires
  ADR 0008 amendment before code lands.
- **Model R4 (P2, new 2026-05-27)** — Walk-ins are not a first-class
  registration type. See **R4**. Product decision needed on
  captain-identity nullability before code lands.
