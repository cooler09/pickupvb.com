...
| [Documentation](documentation.md)                 | 2026-05-22 | Bundle 32 landed [ADR 0009 (canonical-domain-apex)](../adr/0009-canonical-domain-apex.md) and closed two stale P2s (server-action pattern doc, audits-index row). Remaining: `CONTRIBUTING.md` (gated) + remaining P2/P3 docs + 2 ADRs                                                                 |
