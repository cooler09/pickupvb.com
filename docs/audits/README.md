...
| [Documentation](documentation.md)                 | 2026-05-22 | Bundle 31 closed the P1 README sweep ([apps/web/README.md](../../apps/web/README.md) landed). Only `CONTRIBUTING.md` (gated on open-vs-closed) + ADR 0006 backfill remain                                                                                                                              |
