...
| Audit                                             | Date       | Status                                                                                                                                                                                                                             |
| ------------------------------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Security](security.md)                           | 2026-05-22 | Bundle 14 (2026-05-24): P2 #4 admin-client refactor — `checkout-actions`, `tip-actions`, `manage-payments-actions` now RLS-enforced via new self-service + host policies. CSP (P2 #3), rate-limit (P2 #6), and P3 items still open |
