...
| [Documentation](documentation.md)                 | 2026-05-22 | Bundle 30: 5 new package READMEs (application/infrastructure/notifications/types/config). Only `apps/web` README + ADR 0006 + `CONTRIBUTING.md` still open                                                                                                                                             |
