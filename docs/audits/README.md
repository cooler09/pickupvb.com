...
| [Architecture (CQRS/DRY/SOLID)](architecture.md)  | 2026-05-22 | Bundle 22 closed P1 test bootstrap — Vitest is wired and `Team` aggregate now has 32-case coverage (122 domain tests total); events/[id] page-diet P1 still open                                                                                           |
