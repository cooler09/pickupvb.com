...
| [Registration workflow](registration-workflow.md) | 2026-05-24 | Team-paradigm ADR 0008 landed (Bundle 6) — closes audit recommended-sequencing step 1; only UX P2/P3 items left (tabs single-flow refactor, off-platform double-CTA, free-agent claim/grouping, captain pre-pay) |
