...
| Audit                                             | Date       | Status                                                                                                                                                                                                                                          |
| ------------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Security](security.md)                           | 2026-05-22 | Bundle 16 (2026-05-24): P2 #6 rate limiting on email-sending paths — Postgres-backed limiter gates `claimAccount`, `signupAsGuest`, `startGuestTicketCheckout` at 20/h per IP + 5/h per email. CSP enforcement (P2 #3a) and P3 items still open |
