...
| [Performance](performance.md)                     | 2026-05-22 | Bundle 25 (2026-05-22): P1 #1 further resolved — `/teams/[id]`, `/groups/[id]`, `/players/[id]` ISR-cacheable via sessionless anon client + single client-island viewer chrome per page. `/events` + `/events/[id]` + P3 #13 still open                    |
