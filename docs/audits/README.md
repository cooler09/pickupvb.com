...
| [Architecture (CQRS/DRY/SOLID)](architecture.md)  | 2026-05-22 | Both 2026-05-22 P2s resolved (revalidatePath scope rescoped; billing typed errors landed); page-diet regression still open                                                                                                                   |
| [508 / Accessibility](accessibility.md)           | 2026-05-22 | Mobile menu focus trap + shared FieldError landed 2026-05-22 (Bundle 2)                                                                                                                                                                      |
| [SEO](seo.md)                                     | 2026-05-24 | Bundle 18 shipped `BreadcrumbList` JSON-LD; Bundle 20 shipped `SportsTeam` + `SportsOrganization` JSON-LD on teams/groups detail pages; force-dynamic Suspense refactor (P2) still deferred                                                  |
