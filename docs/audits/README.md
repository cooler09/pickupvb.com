...
| [Performance](performance.md)                     | 2026-05-22 | Event detail page-level side-loads collapsed to 2 waves 2026-05-24 (Bundle 9); `getDetail()` JOIN consolidation + listings-Suspense still open                                            |
