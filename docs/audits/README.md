...
| [Architecture (CQRS/DRY/SOLID)](architecture.md)  | 2026-05-22 | Bundle 22 closed P1 test bootstrap (122 domain + 6 application tests); Bundle 23 closed P1 events/[id] page diet via `loadEventDetail` extraction (887 → 566 LOC). No P1s remaining on architecture audit.                                                 |
