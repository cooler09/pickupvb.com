...
| [508 / Accessibility](accessibility.md)           | 2026-05-23 | Bundle 42 (2026-05-23) closed three small P2s: datetime picker Escape + return-focus, `confirm-submit-button` `aria-modal="true"`, and "(opens in new tab)" sr-only cues on `OpenInNewTabButton` + external `QuickShareButton`. Bundle 41 closed the FieldError sweep; Bundle 2 closed the mobile menu focus trap. Remaining: combobox ARIA on address/user pickers, toast focus-ring contrast, all P3s |
