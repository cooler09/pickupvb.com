...
The project maintainer (Zachary Lockhart) is responsible for clarifying
and enforcing these standards and will take appropriate and fair
...
pull requests, discussions, and direct communication relating to the
...
be reported privately to the project maintainer via a GitHub
private security advisory on the
[pickupvb.com](https://github.com/cooler09/pickupvb.com) repository
(Security → Advisories → New draft) — the advisory channel is the only
private channel currently available and works fine for conduct reports.
...
determining the consequences for any action deemed in violation:
